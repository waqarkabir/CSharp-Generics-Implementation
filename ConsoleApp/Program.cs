    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("7. Total Account Transactoions");
                ...
                switch (option)
                {
                    ...
                    case "6":
                        ...
                        bool transferStatus = false;
                            var tranferStatus = senderBankAccount.Transfer(receiverBankAccount, decimal.Parse(amount));
                    ...
                    case "7":
                        ...
                        var accountTransactions = bankAccount.GetAccountTransactions();
                        if (accountTransactions == null)
                        {
                            Console.WriteLine("There are no available transactions in the system.");
                            Console.WriteLine("Press any key for main menu");
                            Console.ReadKey();
                            break;
                        }
